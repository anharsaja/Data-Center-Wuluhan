<head>
    ...
    <title>Desinic - Get Best UI Design</title>
            ...
            <section class="section features" id="features">
                <div class="container">
                    ...
                    <figure class="features-banner">
                        <img src="{{asset('images/feautres-banner.png')}}" width="369" height="318" loading="lazy" alt="Features Banner" class="w-100 banner-animation">
                    </figure>
